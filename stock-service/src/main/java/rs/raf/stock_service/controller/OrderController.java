...
public class OrderController {
    ...
    public ResponseEntity<?> createOrder(
        ...
        } catch (ListingNotFoundException | AccountNotFoundException | ActuaryLimitNotFoundException | PortfolioEntryNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(e.getMessage());
        } catch (StopPriceMissingException | LimitPriceMissingException | PortfolioAmountNotEnoughException e){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(e.getMessage());
        }
    }

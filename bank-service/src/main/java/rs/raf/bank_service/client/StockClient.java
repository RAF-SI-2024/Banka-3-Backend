...
@FeignClient(name = "stock-service", url = "${spring.cloud.openfeign.client.config.stock-service.url}", fallbackFactory = UserClientFallbackFactory.class, decode404 = true)

...
//
//        verify(accountService, times(1)).changeAccountName(validAccountNumber, validNewName, "");  // Changed accountId to accountNumber
//    }
//
...
//                .when(accountService).changeAccountName(validAccountNumber, validNewName, "");  // Changed accountId to accountNumber
//
//        ChangeAccountNameDto request = new ChangeAccountNameDto(validNewName);
//
//        mockMvc.perform(put("/api/account/{accountNumber}/change-name", validAccountNumber)
...
//
//        verify(accountService, times(1)).changeAccountName(validAccountNumber, validNewName, "");
//    }
//
